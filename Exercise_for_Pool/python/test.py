...
while num <26:
  url = 'https://r.gnavi.co.jp/area/jp/continental/rs/?p='+str(num)
...
# df.to_csv("C:/Users/81802/Exercise_for_Pool/python/sample.csv", index=False)
